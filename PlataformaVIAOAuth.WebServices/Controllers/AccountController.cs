namespace PlataformaVIAOAuth.WebServices.Controllers
{
    ...
    using ApplicationUser = Models.ApplicationUser;
    ...
    public class AccountController : ApiController
    {
        ...
        public AccountController(IAdministracionCorreoRepository AdministracionCorreoRepository)
        {
            this.administracionCorreoService = new AdministracionCorreoService(AdministracionCorreoRepository);
        }
        ...
        public async Task<IHttpActionResult> ChangePassword(ChangePasswordBindingModel model)
        {
            try
            {
                ...
                AdministracionCorreo correo = new AdministracionCorreo { ASUNTO = "Cambio de contraseña", DESTINATARIOS = user.Email, COPIA_DESTINATARIOS = "", MENSAJE = "El cambio de la contraseña fue satisfactorio.", TITULO = "Cambio de Contraseña" };
                ...
                administracionCorreoService.SendEmail(correoNuevo);
        ...
        //[HttpPost]
        //[AllowAnonymous]
        //public async Task<IHttpActionResult> ForgotPassword(ForgotPasswordViewModel Model, ResetPasswordViewModel PasswordModel)
        //{
