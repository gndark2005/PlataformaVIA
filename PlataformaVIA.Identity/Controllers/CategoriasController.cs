...
namespace PlataformaVIA.Identity.Controllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id_Categoria,Descripcion")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id_Categoria,Descripcion")] Categoria categoria)
        {
            if (ModelState.IsValid)
            {
